    ...
    <>
      ...
      <section className="py-25 bg-[#0A3F87] ">
        <Container>
          ...
          {/* =======Service Start======= */}
          <div className="serviceHeading text-center flex justify-center mt-20 flex-col items-center">
      ...
      {/* ======Services Start===== */}
      <section className="pb-20 relative bottom-50">
        <Container>
          <div className="serviceWrap flex flex-wrap py-25 ">
            {serviceData.map((item) => (
              <div key={item.id} className="w-[31%]">
                <Image source={item.img} alt={item.title} />
                <h3 className=" my-3 text-5 font-semibold font-quicksand text-[#161C2D]">{item.title}</h3>
